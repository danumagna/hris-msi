...
class MasterFormulaFormPage extends StatefulWidget {
  const MasterFormulaFormPage({super.key, this.initialData});

  final MasterFormulaData? initialData;

  @override
  State<MasterFormulaFormPage> createState() => _MasterFormulaFormPageState();
}

class _MasterFormulaFormPageState extends State<MasterFormulaFormPage> {
  ...
  static const List<String> _tableNameOptions = [
    'tbl_overtime',
    'tbl_leave',
    'tbl_incentive',
    'tbl_payroll',
  ...
  void initState() {
    ...
    _selectedTableName = initial?.tableName ?? _tableNameOptions.first;
  ...
  void _submitForm() {
    ...
    final payload = MasterFormulaData(
      id:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(_isEditMode ? 'Edit Formula Form' : 'Add Form'),
      ),
      body: Form(
        key: _formKey,
        child: ListView(
          ...
          children: [
            ...
            _DropdownField(
              ...
              options: _tableNameOptions,
              onChanged: (value) {
                if (value == null) return;
                setState(() => _selectedTableName = value);
              },
            ),
            const SizedBox(height: 12),
            _DropdownField(
